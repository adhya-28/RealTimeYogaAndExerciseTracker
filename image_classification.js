...
var labels = { ...set1_labels, ...Object.fromEntries(Object.entries(set2_labels).map(([k, v]) => [parseInt(k) + 3, v])) };
...
async function predict() {
    ...
    console.log('Prediction confidence: ' + pred_confidence);
    console.log('Predicted index: ' + pred_index);

    let pre_text = "Prediction: ";
    let result;
    if (pred_confidence >= pconfidence) {
        if (pred_index === 0) {
